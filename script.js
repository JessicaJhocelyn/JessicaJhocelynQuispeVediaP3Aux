...
//1. Cree un método llamado 'registerNewAnswer' en el objeto 'poll'.
// El método hace 2 cosas:
...
const poll = {
    ...
    registerNewAnswer () { let programa=prompt( this.question +"\n"+ this.options[0]+"\n"+ this.options[1]+"\n"+ this.options[2]+"\n"+ this.options[3]+"\n")
     if(programa>=0&&programa<4){
         this.answers[programa]++;
...
//son 13, 2, 4, 1 respectivamente"   
    ...
    { 
        ...
        {
            alert("Los resultados son: "+ type );
            console.log("Los resultados  son: "+ type)  
        }
        else
         {
            (typeof type == " ")
...
//let array1=[5,2,3]
//let array2=[1,5,3,9,6,1]

//poll.displayResults(array1)
//poll.displayResults(array2)
